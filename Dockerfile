...
ADD https://github.com/Crayon112/Sub-Store/releases/latest/download/sub-store.bundle.js /opt/app/sub-store.bundle.js

ADD https://github.com/Crayon112/Sub-Store-Front-End/releases/latest/download/dist.zip /opt/app/dist.zip
